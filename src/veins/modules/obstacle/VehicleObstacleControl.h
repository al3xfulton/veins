...
#ifndef OBSTACLE_VEHICLEOBSTACLECONTROL_H
#define OBSTACLE_VEHICLEOBSTACLECONTROL_H
...
protected:
    ...
    int fakeHeight; /**< fake height to use for non-vehicle senders/receivers (-1: to throw error in this case) */
